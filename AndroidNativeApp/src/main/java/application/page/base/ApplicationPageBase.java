...
public class ApplicationPageBase extends MobileAPI {
    ...
    public static void sendKeysWithOutEnter(WebElement webElement, String webElementName, String keys){
        webElement.clear();
        TestLogger.log("Sending " + keys + " to " + webElementName);
        ...
        public static void ebaySearch(WebElement webElement,String webElementName){
